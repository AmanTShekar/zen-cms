  ...
  theme: {
    extend: {
      colors: {
        ...
        'z-primary': 'var(--z-text-primary)',
        'z-secondary': 'var(--z-text-secondary)',
        'z-muted': 'var(--z-text-muted)',
        'z-inverse': 'var(--z-text-inverse)',
        'z-logo-text': 'var(--z-logo-text)',
        
        'z-sidebar-text': 'var(--z-sidebar-text)',
        'z-sidebar-text-hover': 'var(--z-sidebar-text-hover)',
