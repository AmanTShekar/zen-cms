...
const EmptyCollectionState = ({ slug, theme }: { slug: string, theme: string }) => {
 ...
 className={cn("px-8 py-4 rounded-none font-black text-[11px] uppercase tracking-widest shadow-xl transition-all leading-none flex items-center gap-3", theme === 'dark' ? 'bg-emerald-500 text-white hover:bg-emerald-400 hover:shadow-emerald-500/20' : 'bg-emerald-600 text-white hover:bg-emerald-700 hover:shadow-emerald-600/20')}
 >
...
const CollectionList: React.FC = () => {
 ...
 <span className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.4em] ">REGISTRY_COLLECTION</span>
 ...
 <div className="flex items-center gap-6">
 <Link to={`/collections/${slug}/new`} className={cn('px-8 py-4 rounded-none font-black text-[11px] uppercase tracking-widest shadow-xl transition-all leading-none flex items-center gap-3', theme === 'dark' ? 'bg-white text-black hover:bg-gray-200' : 'bg-emerald-600 text-white shadow-emerald-600/10')}>
 ...
 <div key={stat.label} className={cn('border rounded-none p-6 flex flex-col transition-all', theme === 'dark' ? 'bg-white/[0.02] border-white/[0.08]' : 'bg-white border-gray-100 shadow-sm')}>
 <div className="flex items-center justify-between mb-4">
 <stat.icon size={14} className="text-gray-500" />
 <span className="text-[8px] font-black uppercase text-emerald-500 tracking-[0.2em] ">Operational</span>
 </div>
 ...
 className={cn("px-4 py-2 text-[10px] font-black uppercase tracking-[0.2em] transition-colors", viewMode === 'active' ? 'text-emerald-500 border-b-2 border-emerald-500' : 'text-gray-500 hover:text-gray-900 dark:hover:text-white')}
 >
 Active Records
 </button>
 <button
 ...
 >
 <h4 className="text-[10px] font-black uppercase tracking-[0.2em] mb-4 text-emerald-500">Column_Orchestration</h4>
 ...
 <span className="text-[9px] font-black text-emerald-500 uppercase ">#{String(itemId).slice(-6)}</span>
 </div>
 </td>
 {availableColumns.filter((c) => visibleColumns.includes(c)).map((col) => (
 <td key={col} className="px-6 py-4">
 <span className={cn('text-[10px] font-black uppercase ', col === '_status' && item[col] === 'published' ? 'text-emerald-400' : col === '_status' && item[col] === 'draft' ? 'text-amber-400' : '')}>
 ...
 <span className="text-[10px] font-black text-emerald-500 uppercase tracking-wider">#{String(itemId).slice(-8)}</span>
 </div>
