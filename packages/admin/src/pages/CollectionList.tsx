  ...
  return (
    <div className={cn('p-10 space-y-10 min-h-screen transition-colors duration-500', theme === 'dark' ? 'bg-black text-white' : 'bg-[#fafafa] text-gray-900')}>
      ...
      <div className={cn('border rounded-none overflow-hidden shadow-sm backdrop-blur-3xl transition-all', theme === 'dark' ? 'bg-black/80 border-white/[0.08]' : 'bg-white border-gray-100')}>
        ...
        {layout === 'table' && (
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className={cn('border-b text-left text-[8px] font-black text-gray-500 uppercase tracking-[0.4em] italic', theme === 'dark' ? 'border-white/[0.08]' : 'border-gray-50')}>
        ...
        <div className={cn('p-4 border-t flex items-center justify-between text-[8px] font-black text-gray-500 uppercase italic', theme === 'dark' ? 'border-white/[0.08]' : 'border-gray-50')}>
