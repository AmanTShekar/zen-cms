                ...
                (() => {
                  ...
                  return zone.length > 0 ? (
                    <div className="space-y-2">
                      <p className="text-xs font-black text-gray-500 uppercase italic px-1">
              ...
              <div className="space-y-2">
                ...
                <div className="max-h-64 overflow-y-auto space-y-1.5 custom-editor-scrollbar">
                  {filteredBlocks.length === 0 ? (
                    <p className={cn('text-xs font-bold italic text-center py-4', theme === 'dark' ? 'text-gray-600' : 'text-gray-400')}>
