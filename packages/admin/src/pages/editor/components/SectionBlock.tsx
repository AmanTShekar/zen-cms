        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          {editingBlockName ? (
            ...
            <span
              ...
              className={cn(
                'text-xs font-black uppercase italic truncate cursor-text px-1 flex items-center gap-1.5',
                section.blockName
          ...
          {/* Error pill */}
          {sectionErrorCount > 0 && (
            <span className="px-1.5 py-0.5 text-[8px] font-black uppercase italic bg-rose-500/10 border border-rose-500/20 text-rose-500 shrink-0">
...
const ActionItem: React.FC<{
  ...
  <button
    onClick={onClick}
    className={cn(
      'w-full flex items-center gap-3 px-3 py-2 text-[11px] font-black uppercase italic tracking-wider transition-all',
      danger
