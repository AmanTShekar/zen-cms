                ...
                <div className="flex-1 overflow-y-auto max-h-56 custom-editor-scrollbar px-2 pb-2 space-y-0.5">
                  {loading ? (
                    ...
                    <div className="py-8 text-center">
                      <p className="text-xs font-black uppercase italic text-gray-500">No results found</p>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="truncate font-black italic uppercase tracking-tight">
                              {String(title)}
                            </p>
                            {item._status && (
                              <span className={cn(
                                'text-[7px] font-bold uppercase italic',
