...
export const CollabAvatars: React.FC<CollabAvatarsProps> = ({
  ...
  return (
    <div className="relative flex items-center gap-0">
      ...
      <div
        className={cn(
          'flex items-center gap-1 px-2 py-1 rounded-none border text-[7px] font-black uppercase italic tracking-widest',
          isConnected
            ? theme === 'dark'
      ...
      <AnimatePresence>
        {expanded && (
          ...
          >
            <p className="text-xs font-black uppercase italic text-gray-500 tracking-widest mb-2">
