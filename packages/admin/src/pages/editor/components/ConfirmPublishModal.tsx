...
export const ConfirmPublishModal: React.FC<ConfirmPublishModalProps> = ({
  ...
  return createPortal(
    <AnimatePresence>
      {open && (
        <div className="fixed inset-0 z-[800] flex items-center justify-center bg-[#0B0F19]/60 backdrop-blur-sm">
          <motion.div
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-black uppercase italic tracking-wider">Publish Document</h3>
            ...
            <div className="flex gap-3 mt-5">
              <button
                onClick={onCancel}
                className={cn(
                  'flex-1 py-2.5 text-xs font-black uppercase italic tracking-widest border rounded-none transition-all',
                  theme === 'dark'
