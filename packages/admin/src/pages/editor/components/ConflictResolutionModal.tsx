          ...
          >
            ...
            <div className={cn(
              ...
              <div className="flex-1">
                <h2 className="text-xs font-black uppercase italic tracking-widest text-rose-400">
                  Conflict Detected
                </h2>
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div className={cn(
                ...
                <div className="text-center">
                  ...
                  <p className="text-lg font-black italic text-amber-400">v{serverVersion ?? '?'}</p>
                </div>
              </div>
            </div>
            ...
            <div className={cn(
              ...
              <button
                ...
                className={cn(
                  'flex-1 flex items-center justify-center gap-2 py-3 text-xs font-black uppercase italic tracking-widest border rounded-none transition-all',
                  theme === 'dark'
