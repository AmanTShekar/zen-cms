      ...
      >
            ...
            >
              ...
              >
                {BLOCK_LIBRARY.map((block) => (
                  ...
                  >
                    {block.icon && <block.icon size={13} className="text-indigo-400 shrink-0" />}
        ...
        <div className="flex gap-1 px-1.5 pb-1">
          <button
            ...
            className={cn('flex-1 flex items-center justify-center p-1.5 border rounded-md transition-all', theme === 'dark' ? 'border-white/5 hover:border-indigo-500/30 hover:bg-indigo-500/5 text-gray-400 hover:text-indigo-400' : 'border-gray-200 hover:border-indigo-200 hover:bg-indigo-50 text-gray-600 hover:text-indigo-600')}
          >
