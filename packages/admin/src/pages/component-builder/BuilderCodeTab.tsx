  ...
  return (
    <motion.div key="code" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-4">
      <div className={cn('p-6 border rounded-none', dark ? 'bg-black border-white/[0.08]' : 'bg-white border-gray-200 shadow-sm')}>
        ...
        {/* Format examples */}
        <div className={cn('p-4 rounded-none text-[10px] font-mono mb-4 text-gray-600 dark:text-gray-400 border', dark ? 'bg-black border-white/[0.08]' : 'bg-gray-900 border-gray-700')}>
  ...
  "fields": [
    ...
    { "name": "ctaUrl", "type": "text" }
        ...
        <textarea
          ...
          className={cn('w-full border p-4 text-sm font-mono outline-none focus-visible:ring-2 focus-visible:ring-gray-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black rounded-none placeholder:text-gray-600 resize-none', dark ? 'bg-black border-white/[0.08] focus:border-gray-500/50 text-white' : 'bg-gray-50 border-gray-200 focus:border-gray-500 text-gray-900')}
        />
        ...
        <div className="flex gap-3 mt-4">
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-gray-500 hover:bg-gray-400 text-white text-[10px] font-black uppercase tracking-widest rounded-none transition-all disabled:opacity-40"
          >
