...
const TEMPLATES: Template[] = [
  {
    ...
    stars: 382,
    performanceScore: 99,
    primaryColor: 'from-violet-600 to-indigo-600',
    accentColor: '#8B5CF6',
    features: [
    ...
    >
        ...
        >
          {categories.map((cat) => (
            <button
              ...
              className={cn(
                'px-4 py-2 text-[9px] font-black uppercase tracking-widest rounded-none transition-all italic leading-none whitespace-nowrap',
                activeCategory === cat
                  ? theme === 'dark'
      ...
      >
        ...
        <div className="flex-1 space-y-3 z-10">
          ...
          <h2 className="text-2xl md:text-3xl font-black uppercase italic tracking-tight leading-tight">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="space-y-1">
                    ...
                    <h3 className="text-xl font-black tracking-tight uppercase italic leading-none group-hover:text-indigo-400 transition-colors mt-1.5">
                      {template.name}
                    </h3>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-1">
                    {template.features.map((feat, idx) => (
                      <div key={idx} className="flex items-center gap-2 text-xs text-gray-300">
                        <div className="w-1.5 h-1.5 bg-indigo-500/40 border border-indigo-500 rounded-none shrink-0" />
                ...
                <div className="pt-4 border-t border-white/5 mt-auto flex items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className={cn(
                      'px-5 py-3 rounded-none text-[9px] font-black uppercase tracking-[0.15em] shadow-lg transition-all italic leading-none flex items-center gap-2 active:scale-95 text-white',
                      template.primaryColor
                    )}
                    style={{
          ...
          <div className="fixed inset-0 z-55 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <span className="text-[8px] font-black text-indigo-500 uppercase tracking-[0.25em] italic block">
                    Zero-Config Handshake
                  </span>
                  <h3 className="text-xl font-black uppercase italic tracking-tight leading-none mt-1">
                ...
                {[
                  ...
                  return (
                    <div key={idx} className="flex flex-col gap-1.5">
                      ...
                      <span
                        className={cn(
                          'text-[8px] font-black uppercase tracking-wider italic leading-none mt-0.5',
              ...
              <div className="min-h-[220px] flex flex-col justify-between gap-5">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="pt-4 border-t border-white/5 flex justify-end">
                      <button
                        ...
                        className={cn(
                          'px-8 py-3.5 rounded-none text-[9px] font-black uppercase tracking-[0.2em] shadow-lg transition-all italic leading-none flex items-center gap-2 active:scale-95 text-white',
                          selectedTemplate.primaryColor
                        )}
                      >
                ...
                {deployStep === 4 && (
                  <div className="space-y-6 text-center py-4">
                    ...
                    <div className="space-y-2">
                      <h4 className="text-lg font-black uppercase italic tracking-tight leading-none text-white">
                    ...
                    <div className="pt-4 border-t border-white/5 flex items-center justify-between gap-4 max-w-md mx-auto">
                      ...
                      <a
                        ...
                        rel="noreferrer"
                        className={cn(
                          'w-full py-3.5 rounded-none text-[9px] font-black uppercase tracking-widest transition-all italic leading-none flex items-center justify-center gap-2 text-white',
                          selectedTemplate.primaryColor
                        )}
                      >
                        Launch Storefront
