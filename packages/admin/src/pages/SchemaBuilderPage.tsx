  ...
  return (
    <div className={cn('flex h-[calc(100vh-4rem)] overflow-hidden', dark ? 'bg-[#080808] text-white' : 'bg-gray-50 text-gray-900')}>
        ...
        <div className={cn('px-6 py-4 border-b flex items-center justify-between gap-4 shrink-0', dark ? 'border-white/5 bg-black' : 'border-gray-200 bg-white')}>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={cn('flex items-center gap-2 px-4 py-2 text-[10px] font-black uppercase tracking-widest rounded-none transition-all border', dark ? 'border-white/10 hover:bg-white/5' : 'border-gray-200 hover:bg-gray-50')}
            >
              ...
              <AnimatePresence>
                {fields.map((field, i) => (
                  <motion.div
                    ...
                    className={cn('p-4 border rounded-none relative group', dark ? 'bg-black/40 border-white/5' : 'bg-gray-50 border-gray-100', isCodeFirst && 'opacity-70')}
                  >
                    {/* Delete button */}
                    {!isCodeFirst && (
                      <button
      ...
      <AnimatePresence>
        {showCode && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
            <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} exit={{ scale: 0.95 }} className="w-full max-w-3xl border rounded-none shadow-2xl p-6 relative flex flex-col h-[80vh] bg-[#0B0F19] border-white/10">
              ...
              <div className="flex-1 bg-[#1E1E1E] border border-white/10 p-5 overflow-auto text-sm font-mono text-emerald-400 relative rounded-none">
                <button
      ...
      <AnimatePresence>
        {showAI && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
            <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} exit={{ scale: 0.95 }} className="w-full max-w-lg border rounded-none shadow-2xl p-6 relative bg-[#0B0F19] border-white/10">
              ...
              <textarea
                ...
                className="w-full bg-black border border-white/10 focus:border-purple-500/50 p-4 text-sm outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black rounded-none placeholder:text-gray-600 text-white resize-none mb-4"
              />
              <button
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
            <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} exit={{ scale: 0.95 }} className="w-full max-w-lg border rounded-none shadow-2xl p-6 relative bg-[#0B0F19] border-white/10">
              ...
              <input
                ...
                className="w-full bg-black border border-white/10 focus:border-emerald-500/50 p-3.5 text-sm outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black rounded-none placeholder:text-gray-600 text-white mb-4 font-mono"
              />
              <button
