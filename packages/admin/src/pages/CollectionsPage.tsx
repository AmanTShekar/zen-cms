          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-white/[0.08] pb-3">
                ...
                <button
                  ...
                  className="px-4 py-2 border border-dashed border-emerald-500/30 text-emerald-400 hover:bg-emerald-500/5 text-[9px] font-black uppercase tracking-widest transition-all italic flex items-center gap-2"
                >
            ...
            <div className="mt-10 pt-8 border-t border-white/[0.08] flex justify-end gap-4">
              ...
              <button
                ...
                className="px-8 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-none text-[9px] font-black uppercase tracking-widest shadow-xl shadow-emerald-600/20 transition-all italic flex items-center gap-2 leading-none"
              >
                {visualLoading ? (
