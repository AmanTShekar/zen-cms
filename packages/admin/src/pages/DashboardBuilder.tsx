...
function SortableWidget({
 ...
 className={cn(
 'w-full text-[10px] font-black uppercase outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black bg-transparent border-b border-emerald-500 pb-0.5',
 ...
 <span
 className={cn(
 'text-[10px] font-black uppercase truncate max-w-[120px]',
...
function WidgetPicker({
 ...
 className="bg-transparent text-[11px] font-black uppercase tracking-wider outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black flex-1 placeholder-gray-500"
 />
 </div>
 </div>
...
function WidgetConfigModal({
 ...
 className={cn(
 'w-full px-4 py-2 text-[11px] font-black uppercase tracking-wider border rounded-none focus:border-emerald-500 outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black',
 isDark
 ...
 className={cn(
 'w-full px-3 py-2 text-[11px] font-black uppercase border rounded-none outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black focus:border-emerald-500',
 isDark
 ? 'bg-black border-white/[0.08] text-white'
 : 'bg-white border-gray-200 text-gray-900'
 )}
...
export default function DashboardBuilder() {
 ...
 className={cn(
 'flex items-center gap-2 px-4 py-2 text-[9px] font-black uppercase rounded-none transition-all',
 theme === 'dark'
 ...
 className={cn(
 'flex items-center gap-2 px-5 py-2 border text-[9px] font-black uppercase rounded-none transition-all',
 theme === 'dark'
 ...
 <p className="text-[13px] font-black uppercase text-gray-400">
 ...
 <div
 className={cn(
 'border rounded-none p-4 shadow-2xl opacity-90 font-black text-[11px] uppercase ',
 theme === 'dark'
