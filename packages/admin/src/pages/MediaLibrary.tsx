...
const MediaLibrary = () => {
 ...
 <label
 className={cn(
 'px-8 py-3.5 rounded-none font-black text-[11px] uppercase tracking-widest shadow-xl transition-all leading-none flex items-center gap-4 cursor-pointer',
 theme === 'dark'
 ...
 className="px-4 py-2 text-[9px] font-black uppercase tracking-widest border rounded-none transition-all "
 >
 Clear
 </button>
 <button
 onClick={bulkDelete}
 className="px-4 py-2 text-[9px] font-black uppercase tracking-widest bg-red-600 text-white rounded-none hover:bg-red-700 transition-all flex items-center gap-2"
 >
 <Trash2 size={12} />
 Delete Selected
 </button>
 ...
 className="max-h-full object-contain shadow-[0_40px_100px_rgba(0,0,0,0.5)] relative rounded-none border border-white/[0.08] transition-transform duration-300 select-none"
 draggable={false}
 />
 {isCropMode && cropRect && (
 <div
 ...
 className={cn(
 'flex-1 py-4 rounded-none text-[10px] font-black uppercase tracking-widest transition-all shadow-lg leading-none flex items-center justify-center gap-3',
 theme === 'dark'
 ? 'bg-white text-black hover:bg-gray-200'
 : 'bg-gray-900 text-white hover:bg-black'
 )}
