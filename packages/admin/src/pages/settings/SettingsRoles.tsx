...
const SettingsRoles: React.FC<SettingsRolesProps> = ({
 ...
 <div className="flex items-center justify-between border-b border-white/[0.08] pb-4">
 <div className="flex flex-col">
 <h4 className="text-xs font-black uppercase tracking-widest text-emerald-400">{editingRole.roleName}</h4>
 ...
 className="flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-[10px] font-black uppercase tracking-wider transition-all"
 >
 <Save size={12} />
 Save
 </button>
 ...
 />
 <span className={cn('text-[8px] font-black uppercase tracking-wider', checked ? 'text-emerald-400' : 'text-gray-500')}>{act}</span>
 </label>
 )
 })}
 </div>
