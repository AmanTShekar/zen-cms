    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      ...
      >
        ...
        <div className="px-8 py-6 space-y-5">
          <p className="text-[11px] font-black italic text-gray-300 leading-relaxed">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              disabled={loading}
              className={cn(
                'flex-1 py-3.5 rounded-none text-[10px] font-black uppercase italic tracking-widest shadow-lg transition-all active:scale-95 disabled:opacity-40 flex items-center justify-center gap-2',
