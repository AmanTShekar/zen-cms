...
const SettingsApiKeyModal: React.FC<SettingsApiKeyModalProps> = ({ newKey, setNewKey, theme }) => {
 ...
 <p className="text-[8px] font-bold text-z-secondary uppercase tracking-widest mt-2">
 ...
 className="p-2.5 rounded-none-none bg-gray-500 text-white shrink-0 shadow-lg shadow-[var(--z-active-glow)]/20 hover:scale-105 active:scale-95 transition-all"
 >
 <Copy size={14} />
 </button>
 </div>
 ...
 <p className="text-[10px] font-bold text-z-muted uppercase tracking-widest">
 Frontend .env Integration:
 </p>
 <div className={cn('p-4 rounded-none-none border font-mono text-[9px] whitespace-pre transition-colors text-gray-600 dark:text-z-muted', theme === 'dark' ? 'bg-[#0a0a0a] border-z-border' : 'bg-gray-900 border-gray-800')}>
