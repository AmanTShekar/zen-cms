          ...
          <div className="flex items-center gap-8">
            ...
            <div>
              <div className="flex items-center gap-4 mb-2.5">
                ...
                <span className="text-[11px] font-black text-primary/40 uppercase tracking-[0.3em] italic leading-none">
                  ZENITH_LABS_V2.4
                </span>
              </div>
              <h1 className="text-6xl font-black text-primary tracking-tighter uppercase italic leading-none">
                Playground
              </h1>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10 px-6">
        {[
          ...
          >
            ...
            <div className="text-4xl font-black text-primary tracking-tighter italic uppercase leading-none relative z-10">
              {stat.value}
            </div>
          </motion.div>
        ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 px-6">
        ...
        <div className="bg-surface border border-border rounded-none p-12 shadow-premium relative group overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center gap-8 mb-12 relative z-10">
            ...
            <div>
              <h3 className="text-4xl font-black text-primary tracking-tighter uppercase italic leading-none">
                Neural_Engine
              </h3>
              <p className="text-[12px] font-black text-primary/40 uppercase tracking-[0.4em] italic mt-3 leading-none">
        ...
        <div className="bg-surface border border-border rounded-none p-12 shadow-premium relative group overflow-hidden shadow-2xl">
          ...
          <div className="space-y-12 relative z-10">
            <div className="space-y-6">
              <p className="text-[12px] font-black text-primary/40 uppercase tracking-widest leading-none italic">
                ACTIVE_OPERATORS
              </p>
              <div className="flex -space-x-4">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-16 h-16 rounded-none border-4 border-app bg-primary text-app flex items-center justify-center font-black text-[14px] italic shadow-premium shadow-xl"
                  >
                    OP_{i}
                  </div>
                ))}
                ...
                >
                  <div className="flex items-center gap-8">
                    ...
                    <div className="space-y-2">
                      <p className="text-[18px] font-black text-primary/80 uppercase tracking-tight italic leading-none group-hover/item:text-primary transition-colors">
                        {feature.label}
                      </p>
                      <p className="text-[11px] font-black text-primary/40 uppercase tracking-widest italic leading-none">
                        {feature.detail}
                      </p>
                    </div>
                  </div>
