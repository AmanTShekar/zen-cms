      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {total > 0 && (
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-red-600 hover:bg-red-500 text-white text-xs font-black uppercase italic tracking-widest transition-all border-0"
          >
            <Trash2 size={14} />
            Empty Trash
          </button>
            ...
            >
              ...
              <div className="flex gap-3 justify-center">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-black uppercase italic tracking-widest transition-all border-0 flex items-center gap-2"
                >
                  {restoreLoading && (
            ...
            >
              ...
              <div className="flex gap-3 justify-center">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-red-600 hover:bg-red-500 text-white text-[10px] font-black uppercase italic tracking-widest transition-all border-0 flex items-center gap-2"
                >
                  {purgeLoading && (
                    <Loader2 size={12} className="animate-spin" />
                  )}
