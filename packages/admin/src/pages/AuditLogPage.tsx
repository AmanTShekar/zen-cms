            ...
            {stats && (
              <>
                ...
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-xl font-black italic tracking-tighter leading-none text-red-500">
                    {stats.failed}
                  </span>
                </div>
                <div className={cn('w-px h-8', theme === 'dark' ? 'bg-white/5' : 'bg-gray-100')} />
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-xs font-black text-emerald-500 tracking-tighter italic uppercase leading-none">
                    Stable
                  </span>
                </div>
              </>
      ...
      >
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              ...
              >
                <th className="px-8 py-4 text-[8px] font-black text-gray-500 uppercase tracking-[0.3em] italic">
                  Operator
                </th>
                <th className="px-8 py-4 text-[8px] font-black text-gray-500 uppercase tracking-[0.3em] italic">
                  Action
                ...
                <th className="px-8 py-4 text-[8px] font-black text-gray-500 uppercase tracking-[0.3em] italic text-right">
                  Timestamp
                </th>
              </tr>
            </thead>
            ...
            >
              {loading ? (
                ...
                <tr>
                  <td colSpan={5} className="py-20 text-center">
                    <div className="text-gray-500 text-sm font-bold uppercase tracking-widest italic">
                      No audit logs found
                    </div>
                  </td>
                </tr>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <span className="text-[7px] font-black uppercase tracking-[0.4em] italic text-gray-500">
              SECURE AUDIT TRAIL
            </span>
          ...
          <div className="flex items-center gap-3">
            <span className="text-[7px] font-black uppercase tracking-widest text-gray-500 italic">
