        ...
        {activeSchema ? (
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-black uppercase tracking-widest italic">Content-Type Builder</h1>
          ...
          <div className="h-full flex items-center justify-center">
            <div className="text-center space-y-4 max-w-sm">
              ...
              <p className="text-[12px] font-black uppercase tracking-[0.3em] text-gray-400 italic">Schema Architect</p>
