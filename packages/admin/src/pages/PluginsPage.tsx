...
const PluginsPage = () => {
 ...
 className={cn(
 'px-6 py-2 text-[9px] font-black uppercase tracking-widest rounded-none transition-all leading-none',
 ...
 <div className="flex flex-col">
 <h3 className="text-sm font-black tracking-tight uppercase leading-none group-hover:text-emerald-500 transition-colors">
 {plugin.name}
 </h3>
 ...
 className={cn(
 'flex items-center gap-2 px-6 py-2.5 rounded-none text-[9px] font-black uppercase tracking-widest transition-all leading-none border shadow-md',
 installed
 ...
 />
 <span className="text-[9px] font-black text-gray-500 lowercase tracking-tight flex items-center gap-1">
 ...
 <footer
 className={cn(
 'h-10 border rounded-none flex items-center px-6 justify-between text-[8px] font-black tracking-[0.3em] uppercase transition-colors backdrop-blur-xl',
 theme === 'dark'
