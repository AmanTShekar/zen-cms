                  ...
                  >
                    ...
                    <div className="px-3 py-2 space-y-1 max-h-36 overflow-y-auto" style={{ scrollbarWidth: 'none' }}>
                      ...
                      {node.fields.length > 8 && (
                        <p className="text-[9px] text-gray-500 italic pt-1">+{node.fields.length - 8} more fields</p>
                      )}
                      {node.fields.length === 0 && (
                        <p className="text-[9px] text-gray-600 italic">No fields defined</p>
                      )}
                    </div>
        ...
        {selectedNode && (
          <motion.aside
            ...
            className={cn(
              ...
              dark ? 'bg-[#0a0f1a]/95 border-white/[0.06] backdrop-blur-2xl' : 'bg-white/95 border-gray-200 backdrop-blur-xl'
            )}
          >
