...
const STEP_TYPES = [
 ...
 description: 'Internal system alert dispatch',
 },
 {
 id: 'webhook',
 name: 'Webhook',
 ...
 description: 'SMTP communication relay',
 },
 {
 id: 'transform',
 name: 'Script',
 ...
 icon: Terminal,
 color: 'text-gray-400',
 description: 'Permanent record entry',
 },
]
...
const FlowBuilderPage: React.FC = () => {
 ...
 <span className="text-[10px] font-black uppercase tracking-[0.5em] text-emerald-600 dark:text-emerald-500 ">
 ...
 return (
    <div className={cn('-m-6 md:-m-10 h-[calc(100vh-73px)] flex flex-col md:flex-row overflow-hidden select-none font-sans', 'bg-[#fafafa] dark:bg-black')}>
      {/* ── Left Sidebar: Sequences ── */}
      <div className="w-full md:w-72 border-r border-white/[0.08] flex flex-col backdrop-blur-[12px] bg-white/50 dark:bg-black/60 shadow-[4px_0_30px_rgba(0,0,0,0.1)] z-20">
 <div className="p-6 border-b border-white/[0.08] flex items-center justify-between">
 <div className="flex items-center gap-3">
 <div className="w-1.5 h-1.5 indicator-blue" />
 <h1 className="text-[10px] font-black uppercase tracking-[0.3em] text-white">
 Registry
 </h1>
 </div>
 <button
 ...
 <p className="text-[8px] text-gray-700 uppercase tracking-tighter truncate w-full group-hover:text-gray-500">
 {flow.description}
 </p>
 </button>
 ))}
 ...
 className="bg-transparent text-xl font-black text-white uppercase tracking-tighter outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black focus:text-emerald-600 dark:text-emerald-500 transition-colors"
 />
 ...
 <div className="flex flex-col items-center">
                  <div
                    className={cn(
                      'w-full bg-white/80 dark:bg-black/65 backdrop-blur-[12px] border p-8 flex flex-col items-center gap-6 relative transition-all group shadow-[0_4px_30px_rgba(0,0,0,0.1)]',
                      activeStepId === 'trigger'
                        ? 'border-emerald-500 shadow-[0_0_40px_rgba(16,185,129,0.3)] scale-[1.02] z-10'
 ...
 <h3 className="text-lg font-black text-white uppercase tracking-tighter mt-1">
 ...
 setSelectedFlow({
 ...selectedFlow,
 trigger: { ...selectedFlow.trigger, type: t.id as any },
 })
 }}
 className={cn(
 'py-2 text-[8px] font-black uppercase tracking-widest transition-all',
 selectedFlow.trigger.type === t.id
 ? 'bg-white text-black'
 : 'text-gray-600 hover:text-white bg-white/5'
 )}
 >
 {t.detail}
 </button>
 ...
 <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-2 h-2 border-b border-r border-white/[0.08] rotate-45" />
 </div>
 </div>
 ...
 >
                    <div
                      className={cn(
                        'w-full bg-white/80 dark:bg-black/65 backdrop-blur-[12px] border p-6 flex items-center gap-6 relative transition-all group cursor-pointer shadow-[0_4px_30px_rgba(0,0,0,0.1)]',
                        isActive
                          ? 'border-emerald-500 shadow-[0_0_40px_rgba(16,185,129,0.3)] scale-[1.02] z-10'
                          : 'border-gray-200 dark:border-white/[0.08] hover:border-emerald-500/50'
                      )}
 ...
 <span className="text-[7px] font-black text-gray-600 uppercase tracking-widest border border-white/[0.08] px-1">
 NODE_{idx + 1}
 </span>
 </div>
 <p className="text-[8px] text-gray-500 uppercase tracking-widest mt-1 truncate">
 ...
 setSelectedFlow({
 ...selectedFlow,
 steps: selectedFlow.steps.filter((s) => s.id !== step.id),
 })
 ...
 className="absolute top-full left-1/2 -translate-x-1/2 mt-6 bg-zinc-900 border border-white/[0.08] p-4 grid grid-cols-2 gap-3 z-50 min-w-[320px] shadow-2xl"
 >
 {STEP_TYPES.map((type) => (
 <button
 key={type.id}
 onClick={() => addStep(type.id)}
 className="flex items-center gap-4 p-4 hover:bg-white/5 transition-all text-left group border border-transparent hover:border-white/[0.08]"
 >
 <div
 className={cn(
 ...
 <div>
 <div className="text-[9px] font-black text-white uppercase tracking-tight leading-none">
 {type.name}
 </div>
 <div className="text-[7px] text-gray-600 uppercase tracking-tighter mt-1 ">
 {type.id}
 </div>
 </div>
 </button>
 ...
 {activeStepId && (
          <motion.div
            ...
            exit={{ x: 400 }}
            className={cn(
              "w-96 flex flex-col z-20 border-l shadow-2xl",
              "bg-white/95 border-gray-200 backdrop-blur-[12px] dark:bg-black/65 dark:border-white/[0.08]"
            )}
          >
 <div className="p-6 border-b border-white/[0.08] flex items-center justify-between">
 <div className="flex items-center gap-3">
 ...
 <Info size={12} className="text-emerald-600 dark:text-emerald-400" />
 <span className="text-[8px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">
 Protocol_Info
 </span>
 </div>
 <p className="text-[9px] text-gray-500 uppercase tracking-tighter leading-relaxed ">
 This sequence initiates when the specified trigger condition is met.
 Ensure your endpoint or event listener is correctly synchronized.
 </p>
 </div>
 ...
 <div className="text-[10px] font-black text-white bg-white/5 border border-white/[0.08] p-4 uppercase">
 ...
 <div className="p-4 bg-zinc-950 border border-white/[0.08] flex items-center justify-between group">
 <code className="text-[9px] text-emerald-600 dark:text-emerald-400 truncate">
 ...
 onChange={(e) => {
 const newSteps = selectedFlow.steps.map((s) =>
 s.id === activeStepId ? { ...s, name: e.target.value } : s
 )
 setSelectedFlow({ ...selectedFlow, steps: newSteps })
 }}
 className="w-full bg-zinc-950 border border-white/[0.08] p-4 text-[11px] text-white uppercase tracking-tighter outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black focus:border-emerald-500 transition-all"
 />
 </div>
 ...
 <Code2 size={12} className="text-emerald-600 dark:text-emerald-500" />
 </div>
 <textarea
 ...
 const newSteps = selectedFlow.steps.map((s) =>
 s.id === activeStepId
 ? { ...s, config: { ...s.config, script: e.target.value } }
 : s
 )
 setSelectedFlow({ ...selectedFlow, steps: newSteps })
 }}
 className="flex-1 w-full bg-zinc-950 border border-white/[0.08] p-4 text-[10px] text-emerald-600 dark:text-emerald-500 font-mono resize-none outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black focus:border-emerald-500 transition-all h-64 no-scrollbar"
 />
 ...
 <Variable
 size={10}
 className="text-gray-800 hover:text-emerald-600 dark:text-emerald-500 transition-colors cursor-pointer"
 />
 </div>
 <input
 type="text"
 ...
 const newSteps = selectedFlow.steps.map((s) =>
 s.id === activeStepId
 ? { ...s, config: { ...s.config, [key]: e.target.value } }
 : s
 )
 setSelectedFlow({ ...selectedFlow, steps: newSteps })
 }}
 className="w-full bg-zinc-950 border border-white/[0.08] p-4 text-[10px] text-white uppercase tracking-widest outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-black focus:border-emerald-500 transition-all"
 />
 </div>
 ))}
 </div>
 ...
 <button className="w-full py-4 bg-white/5 border border-white/[0.08] text-[9px] font-black text-gray-500 uppercase tracking-[0.3em] hover:bg-white hover:text-black hover:border-white transition-all flex items-center justify-center gap-2">
 <Play size={12} />
 Test_Node_Logic
 </button>
 </div>
 ...
 <Workflow
 size={64}
 className="group-hover:text-emerald-600 dark:text-emerald-500 transition-all duration-700 group-hover:scale-110"
 />
 ...
 <p className="text-[11px] text-gray-600 uppercase tracking-[0.4em] max-w-lg leading-[2.2] relative z-10">
 Construct high-fidelity operational sequences. Orchestrate data flows, system
 protocols, and tactical notifications with absolute geometric precision.
 </p>
