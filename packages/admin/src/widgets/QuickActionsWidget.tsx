...
const ACTIONS = [
 { title: 'New Content', icon: Plus, path: '/collections', color: 'bg-gray-500' },
 { title: 'Media Library', icon: Box, path: '/media', color: 'bg-gray-500' },
...
export default function QuickActionsWidget({ config = {}, theme }: WidgetProps) {
 ...
 : 'bg-white border-gray-200 shadow-sm shadow-sm hover:shadow-md'
 )}
 >
 <div
 className={cn(
 ...
 <div>
 <p className="text-[11px] font-black uppercase leading-none mb-1">{a.title}</p>
 {a.sub && (
