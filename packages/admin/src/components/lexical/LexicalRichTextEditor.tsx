...
function LexicalEditorInner({ mode, placeholder, disabled, autoFocus }: {
 ...
 mode === 'heading'
 ? 'text-5xl md:text-7xl font-black tracking-tighter p-0 min-h-0 uppercase leading-[0.85]'
 : mode === 'inline'
 ? 'text-2xl font-bold p-0 min-h-0 tracking-tight'
 : mode === 'micro'
 ? 'text-[12px] font-black uppercase tracking-[0.2em] p-4 min-h-0 opacity-80'
