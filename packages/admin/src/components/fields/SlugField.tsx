  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        disabled={disabled}
        className={cn(
          'w-full bg-white/[0.05] backdrop-blur-md border border-white/10 rounded-none pl-9 pr-10 py-2 text-sm',
          'focus:border-purple-500/50 outline-none disabled:opacity-60 disabled:cursor-not-allowed',
          'text-purple-300 font-mono placeholder:text-gray-500'
        )}
      ...
      {sourceField && (
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 p-1 text-gray-500 hover:text-purple-400 disabled:opacity-30 transition-colors"
        >
          <RefreshCw size={13} />
        </button>
      )}
