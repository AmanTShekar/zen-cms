...
import type { FieldConfig, GroupFieldConfig } from '@zenithcms/types'
...
const GroupField: React.FC<GroupFieldProps> = ({ field, value, onChange, disabled, renderField }) => {
 ...
 <span className="text-[9px] font-black uppercase tracking-[0.3em] text-emerald-600 dark:text-emerald-400">
 {field.label || field.name}
 </span>
 {gf.admin?.description && (
 <span className="text-[10px] text-gray-500 ">{gf.admin.description}</span>
 )}
 </div>
