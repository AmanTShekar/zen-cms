...
const MediaPicker: React.FC<MediaPickerProps> = ({ value, onChange, hasMany, disabled = false }) => {
        ...
        {isOpen && (
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 md:p-10 bg-[#0B0F19]/80 backdrop-blur-md">
            ...
            >
              ...
              <div className="p-8 border-t border-white/5 flex items-center justify-between bg-[#111827]/40 relative z-10">
