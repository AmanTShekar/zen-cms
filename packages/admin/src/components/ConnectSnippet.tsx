  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        {testResult === 'ok' && (
          <span className="flex items-center gap-2 text-[9px] font-black uppercase italic text-emerald-500">
            <CheckCircle2 size={13} /> Connected successfully
          </span>
        )}
        {testResult === 'error' && (
          <div className="text-[9px] font-black uppercase italic text-red-400 space-y-1">
            <p>Connection failed. Check that:</p>
            <ul className="list-disc list-inside text-gray-500 normal-case not-italic font-medium space-y-0.5">
              <li>
