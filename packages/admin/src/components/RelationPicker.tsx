          ...
          <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 md:p-10 bg-[#0B0F19]/20 backdrop-blur-md">
            ...
            >
              ...
              <div className="p-8 border-t border-gray-50 bg-gray-50/50 flex justify-end">
                <button
                  onClick={() => setIsOpen(false)}
                  className="px-8 py-3 bg-gray-900 text-white rounded-none text-[10px] font-black uppercase tracking-widest shadow-xl shadow-gray-900/20 hover:brightness-110 transition-all italic leading-none"
                >
                  Close_Registry
                </button>
              </div>
