...
passport.use(
  new MultiSamlStrategy(
    ...
    (req: import('express').Request, profile: Record<string, any>, done: Record<string, any>) => {
...
passport.use(
  new GoogleStrategy(
    ...
    (accessToken: string, refreshToken: string, profile: Record<string, any>, done: Record<string, any>) => {
