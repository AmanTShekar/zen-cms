...
export class RLSService {
  static applyReadAccess(query: Record<string, any>, configAccess: any, user: any): boolean {
  ...
  static applyUpdateAccess(query: Record<string, any>, configAccess: any, user: any, req?: any): void {
  ...
  static applyDeleteAccess(query: Record<string, any>, configAccess: any, user: any, req?: any): void {
