...
import api from '../../packages/admin/src/lib/api';
...
test.describe('Advanced Localization', () => {
  ...
  test('Create a localized collection and verify locale switcher exists in editor', async ({ page, request }) => {
    ...
    const hasLocaleSwitcher = await page.locator(
