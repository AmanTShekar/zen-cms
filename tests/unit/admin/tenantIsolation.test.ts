...
import apiInstance from '../../../packages/admin/src/lib/api'
import { useTenantStore } from '../../../packages/admin/src/lib/tenantStore'
import { ApiError } from '../../../packages/admin/src/lib/ApiError'
import { vi } from 'vitest'

vi.stubEnv('VITE_API_URL', 'http://localhost:5173/api/v1')
